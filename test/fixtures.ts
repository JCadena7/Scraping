...
export const latestWithRejectedRow = `<table class="tablaresultados"><thead><tr><th>Nombre</th><th>Número</th><th>Fecha</th><th></th></tr></thead><tbody>
<tr><td>Antioqueñita Día</td><td><span class="balotera-home">0</span><span class="balotera-home">0</span><span class="balotera-home">1</span><span class="balotera-home">7</span></td><td>2026-07-23</td><td><a class="botonres_vmas" href="/resultados/resultados-sorteo-antioquenita-dia/">VER MÁS</a></td></tr>
<tr><td>Malformed row</td><td>9999</td><td>2026-07-23</td><td></td></tr>
</tbody></table>`;
